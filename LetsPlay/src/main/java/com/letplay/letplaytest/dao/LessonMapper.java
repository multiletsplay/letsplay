...
public interface LessonMapper {
	...
	@Insert(" INSERT INTO `LESSON_RESERVATION` VALUES(NULL, #{id}, #{lesSeq}, #{resDate}, #{resStarttime}, #{resEndtime}, #{lesCost} )")
	int insertLesRes(LessonResDto dto);
	
	@Insert(" INSERT INTO `LESSON` VALUES(NULL, #{lesName}, #{spoId}, #{lesTeacher}, #{lesLocation}, #{lesContact}, #{lesImg}, NOW(), #{lesType}, #{lesWeekend}, #{lesCost}) ")
